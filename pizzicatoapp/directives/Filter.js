            ...
            return{
                ...
                link: {
                    ...
                    post: function (scope, elem, attr, ctrl) {
                        ...
                        var removeBtn = $compile(angular.element("</div><div class=\"row\"><button ng-click=\"removeFilter(filter)\" class=\"btn btn-primary\">Remove " + attr.filter + "</button><hr style=\"border-color:#e6f3ff\"></div>"))(scope);
